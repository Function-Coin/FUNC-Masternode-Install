...
COIN_DAEMON='/usr/local/bin/funcd'
COIN_CLI='/usr/local/bin/func-cli'
COIN_REPO='https://github.com/Function-Coin/FUNC/releases/download/v1.0.5/func-1.0.5-x86_64-linux-gnu.tar.gz'
COIN_NAME='FUNC'
COIN_PORT=12280
...
addnode=67.207.84.51
addnode=62.171.154.117
addnode=193.200.241.138
addnode=207.180.249.225
addnode=79.143.188.183
addnode=167.86.89.64
addnode=173.249.41.92
addnode=144.91.70.209
addnode=207.180.242.14
addnode=173.212.203.219
addnode=94.177.240.207
addnode=149.28.169.115
